...
[Delivery Prediction Model](https://github.com/Daniel-Carpenter/IDA-Final-Project#initelligent-data-analytics---final-project) | Ensemble of **machine learning** algorithms in `R` to predict estimated delivery time for food delivery service, given delivery conditions.
