...
[Delivery Prediction Model in `R`](https://github.com/Daniel-Carpenter/IDA-Final-Project#initelligent-data-analytics---final-project) | Ensemble of **machine learning** algorithms in `R` to predict estimated delivery time for food delivery service, given delivery conditions.
[Applied Predictive Analysis in `R`](https://github.com/Daniel-Carpenter/Advanced-Analytics-in-R#advanced-data-analysis-with-r) | Applies **ML, deep learning, decision trees, traditional multivariate analysis** to real-world business problems.
