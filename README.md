...
[Delivery Service ETA Prediction Model in `R`](https://github.com/Daniel-Carpenter/Advanced-Analytics-in-R#advanced-data-analysis-with-r) | Ensemble of **machine learning** algorithms in `R` to predict estimated delivery time for food delivery service, given delivery conditions.
